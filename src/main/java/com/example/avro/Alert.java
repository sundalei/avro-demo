...
public class Alert extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private com.example.avro.AlertStatus status;
   ...
   */
  public Alert(java.lang.Long sensor_id, java.lang.Long time, com.example.avro.AlertStatus status) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: status = (com.example.avro.AlertStatus)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public com.example.avro.AlertStatus getStatus() {
    return status;
  }
   ...
   * @param value the value to set.
   */
  public void setStatus(com.example.avro.AlertStatus value) {
    this.status = value;
  }
   ...
   */
  public static com.example.avro.Alert.Builder newBuilder() {
    return new com.example.avro.Alert.Builder();
  }
   ...
   * @return A new Alert RecordBuilder
   */
  public static com.example.avro.Alert.Builder newBuilder(com.example.avro.Alert.Builder other) {
    if (other == null) {
      return new com.example.avro.Alert.Builder();
    } else {
      return new com.example.avro.Alert.Builder(other);
    }
  }
   ...
   * @return A new Alert RecordBuilder
   */
  public static com.example.avro.Alert.Builder newBuilder(com.example.avro.Alert other) {
    if (other == null) {
      return new com.example.avro.Alert.Builder();
    } else {
      return new com.example.avro.Alert.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Alert>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.avro.Alert.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.avro.Alert other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.sensor_id)) {
        this.sensor_id = data().deepCopy(fields()[0].schema(), other.sensor_id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.Alert.Builder setSensorId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.Alert.Builder clearSensorId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.Alert.Builder setTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.Alert.Builder clearTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.Alert.Builder setStatus(com.example.avro.AlertStatus value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.Alert.Builder clearStatus() {
      status = null;
    ...
    public Alert build() {
      try {
        ...
        record.status = fieldSetFlags()[2] ? this.status : (com.example.avro.AlertStatus) defaultValue(fields()[2]);
        return record;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      this.status = com.example.avro.AlertStatus.values()[in.readEnum()];
